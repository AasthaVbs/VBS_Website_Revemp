...
const SwiperImage1 = "/image/project5-slider1.jpg";
const SwiperImage2 = "/image/project5-slider2.jpg";
const SwiperImage3 = "/image/project5-slider3.jpg";
...
const threeModelingRenderings = () => {
    const data = [
        ...
        { id: 2, text: "High-Quality Interior & Exterior Renderings" },
        { id: 3, text: "Customized Views" },
        { id: 4, text: "Walkthrough Video" }
    ];
            ...
            <section className="home-banner-2 pb-10 pt-4 vbs-project-detail-hero" style={{ backgroundImage: `url(${bannerImage})` }} >
                <Container>
                    <Col lg={9} xs={12} className="text-center mx-auto">
                        ...
                        <h1>Architectural BIM & Rendering</h1>
                    </Col>
                </Container>
            </section>
...
export default threeModelingRenderings;