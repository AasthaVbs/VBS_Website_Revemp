...
const SwiperImage1 = "/image/project13-slider-1.jpg";
const SwiperImage2 = "/image/project13-slider-2.jpg";
...
const Portfolio3dbimodelingwithclashdetectioncoordinationforresidentialproject = () => {
    const data = [
        { id: 1, text: "CAD to BIM Conversion" },
        { id: 2, text: "LOD 350 BIM Model" },
        { id: 3, text: "Clash Detection" },
        { id: 4, text: "Interdisciplinary Coordination" },
        { id: 5, text: "Construction Scheduling and Project Tracking" },
...
export default Portfolio3dbimodelingwithclashdetectioncoordinationforresidentialproject;
