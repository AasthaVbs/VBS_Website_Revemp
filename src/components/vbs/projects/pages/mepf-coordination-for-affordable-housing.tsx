...
const CS_IMG = {
  ...
  ductPipe3d: encodeURI("/image/Clash-Free-MEPF-Coordination-for-56-Unit-Residential-Development.png"),
  inputOutputDiagram: encodeURI("/image/Input-Output (1)-ocean-ave.svg"),
  ...
  executionStrategy2: encodeURI("/image/Execution STrategy (1)-ocean-ave.svg"),
};
...
const META_ITEMS = [
  ...
  { icon: "map-pin", label: "Location", value: "Revere, MA" },
];
...
const SCOPE_ITEMS = [
  { caseStudyIcon: "hvacSystemModeling", title: "MEPF BIM Modeling" },
  { caseStudyIcon: "clashDetection", title: "Clash Detection & Coordination" },
  { caseStudyIcon: "constructionDocs", title: "Penetration Drawings Development" },
  { caseStudyIcon: "mechanicalSystemModeling", title: "Revit Model Setup and Management" },
  { caseStudyIcon: "coordinationMeetings", title: "Coordination Documentation and Reporting" },
];
...
const IMPACT_ITEMS = [
  ...
  { big: "7000", suffix: "", label: "Clash Detected & Resolved" },
];
...
function MepfCoordinationForAffordableHousingPage() {
  useEffect(() => {
            ...
            <div className="hvac-hero__top">
              <Reveal>
                <h1 className="hvac-hero__title fw-bold text-dark">
                  <span className="acc">Clash-Free MEPF Coordination</span> for 56-Unit Residential Development : Revere, MA
                </h1>
                <p className="hero-sub lead text-secondary">Delivered precise LOD 350 BIM coordination across complex MEPF systems for a multi-story affordable housing project.</p>
              </Reveal>
              <Reveal delayClass="d1">
                <div className="hero-img-wrap">
                  <img
                    src={CS_IMG.ductPipe3d}
                    alt="MEPF BIM coordination for affordable housing project in Revere, MA"
                  />
            ...
            <Reveal delayClass="d1">
              <div className="ov-body">
                <p className="text-secondary">
                  When an MEPF firm needed dependable BIM expertise, they turned to us. The project was a 79,100 sq. ft., 7-story affordable housing building in Revere, MA. It featured 56 residential units, supportive group-living spaces, and ground-floor community areas. We delivered fully coordinated LOD 350 MEPF models, resolved all clashes, and produced penetration drawings within a 2-month timeline.
                </p>
              </div>
            </Reveal>
          </div>
          ...
          <div className="wrap">
            ...
            <div className="testi-sec">
              <Reveal delayClass="d1" className="testi-inner">
                <p className="text-secondary">
                  &quot;Working with Virtual Building Studio was an exceptional experience. Their team demonstrated outstanding expertise, ensuring accurate modeling, seamless coordination, and practical solutions to complex challenges. The final model has greatly improved our planning and facility management processes, saving time and reducing costs.&quot;
                </p>
              ...
              <div className="">
                <div className="cta-inner">
                  <h2 id="hvac-cta-heading" className="cta-h text-dark">
                    Ready to achieve precise coordination and eliminate costly site conflicts?
                  </h2>
                  <button
                    type="button"
                  ...
                  >
                    Let Us Coordinate Your Project
...
export default MepfCoordinationForAffordableHousingPage;
