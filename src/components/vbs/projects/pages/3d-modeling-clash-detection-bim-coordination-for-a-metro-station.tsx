...
const SwiperImage1 = "/image/project8-slider1.jpg";
const SwiperImage2 = "/image/project8-slider2.jpg";
...
const threedModelingClashDetection = () => {
    const data = [
        { id: 1, text: "LOD 400 Structural & Architectural Façade Model" },
        { id: 2, text: "Clash Detection & Coordination" },
        { id: 3, text: "Quantity Estimation" },
        { id: 4, text: "Constructability Reviews" }
    ];
            ...
            <section className="home-banner-2 pb-10 pt-4 vbs-project-detail-hero" style={{ backgroundImage: `url(${bannerImage})` }} >
                <Container>
                    <Col lg={9} xs={12} className="text-center mx-auto">
                        ...
                        <h1>Structural and Facade 3D Modeling with Clash Detection</h1>
                    </Col>
                </Container>
            </section>
...
export default threedModelingClashDetection;
