...
export const scanToBimHero = {
  ...
  imageSrc: "/image/scan-to-bim.jpg",
};
...
export const scanToBimIntroCopy = {
  ...
  mainImage: encodeURI("/image/Construction-Ready-scan 1.png"),
};
...
export const scanToBimWhatYouGetSection = {
  ...
  resultLabel: "",
  resultText:
    "The Result Box: Uncompromisingly accurate as-built models slash site rework by up to 25% and drive a 50% faster decision-making lifecycle for multi-trade project teams.",
};
...
export const scanToBimFullSpectrumCards = [
  ...
  },
  {
    ...
    image: "/image/scan to 3d model (2).jpg",
  ...
  },
  {
    ...
    image: "/image/scan-to-3d-mesh.jpg",
  ...
  },
  {
    ...
    image: "/image/scan-to-visualization.jpg",
  ...
  },
  {
    ...
    image: "/image/scan-to-revit-family.jpg",
  ...
  },
  {
    ...
    image: "/image/scab-to-arcthitect.jpg",
    href: "#",
  },
];
...
const SCAN_BENEFIT_ICON_MUTED = "/images/mep/key-benefits/icon-benefit-muted.svg";
