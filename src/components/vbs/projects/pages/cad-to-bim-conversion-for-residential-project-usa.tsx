...
const SwiperImage1 = "/image/project12-slider-1.jpg";
...
const PortfoliocadtobimConversionForResidentialProjectUsa = () => {
    const data = [
        { id: 1, text: "LOD300 BIM Model" },
        { id: 2, text: "Accurate Architectural elements representation" },
    ];
...
export default PortfoliocadtobimConversionForResidentialProjectUsa;
