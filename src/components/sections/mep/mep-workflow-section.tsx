      ...
      <PageContainer className="flex flex-col items-center gap-10 lg:gap-[60px]">
        <div className="flex w-full max-w-[890px] flex-col items-center gap-5 text-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <h2 className="max-w-[688px] capitalize text-[#111111]">
              <span className="text-[48px] font-medium leading-[1.15]">Our Revit MEP BIM </span>
              <span className="text-[48px] font-light leading-[1.15] text-[#D70416]">Services Workflow</span>
            </h2>
          </div>
