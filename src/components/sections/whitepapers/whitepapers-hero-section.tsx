...
export function WhitepapersHeroSection() {
  const { tag, titleLead, titleAccent, description, ctaLabel, image, imageAlt } = whitepapersPageHero;

  return (
    <section className="resources-listing-hero overflow-hidden bg-white py-12 lg:py-[100px]">
      <PageContainer>
