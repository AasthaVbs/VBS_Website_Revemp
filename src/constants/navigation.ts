...
export const RESOURCES_DROPDOWN_LINKS: NavDropdownLink[] = [
  ...
  { label: "News & Updates", href: ROUTES.news },
...
export const CAPABILITY_CATEGORIES: CapabilityCategory[] = [
  {
    ...
    services: [
      [
        ...
        { label: "Architecture BIM Service", href: ROUTES.architecturalBim },
        { label: "Structure BIM Service", href: ROUTES.structuralBim },
        { label: "4D Simulation Service", href: ROUTES.fourDBimScheduling },
        { label: "CAD to BIM Services", href: ROUTES.cadToBim },
        { label: "Architecture Drafting Service", href: ROUTES.architecturalDrafting },
        { label: "CAD Drafting Services", href: ROUTES.cadDrafting },
      ],
      [
        ...
        { label: "Permit Drawings Services", href: ROUTES.permitDrawing },
        { label: "Zoning Analysis Services", href: ROUTES.zoningAnalysis },
        { label: "Construction Document Services", href: ROUTES.constructionDocumentation },
        { label: "3D Visualization Service", href: ROUTES.visualization },
        { label: "Revit Family Creation Services", href: ROUTES.revitFamilies },
      ],
    ],
  },
  {
  ...
  },
  {
    ...
    services: [
      ...
      [
        ...
        { label: "Architectural Scan to BIM", href: ROUTES.scanToBimArchitectural },
      ],
    ],
  },
];
