...
export const ROOT = "hvac-case";

const CS_IMG = {
  /** Hero — mechanical plant room clash-free BIM visualization */
  ductPipe3d: encodeURI("/image/Clash-Free-BIM-Modeling-for-Plant-Room-Refurbishment-Project.png"),
  inputOutputDiagram: encodeURI("/image/Plant_Input-Output.svg"),
  ioInput1: encodeURI("/image/Plant_Input (1).jpg"),
  ioInput2: encodeURI("/image/Plant_Input (5).jpg"),
  ioOutput1: encodeURI("/image/Plant_Output (1).jpg"),
  ioOutput2: encodeURI("/image/Plant_Output (2).jpg"),
  /** Filename uses leading `PLant_` as on disk in `static/image/`. */
  executionStrategy2: encodeURI("/image/PLant_Execution Strategy.svg"),
};
...
const META_ITEMS = [
  { icon: "building-2", label: "Project Type", value: "Mechanical Plant Room " },
  { icon: "layers", label: "Level of Development", value: "LOD 300" },
  { icon: "users", label: "Manpower Used", value: "2 Resources" },
  { icon: "map-pin", label: "Location", value: "UK" },
];
...
const SCOPE_ITEMS = [
  { caseStudyIcon: "mechanicalSystemModeling", title: "Mechanical Plant Room Modeling" },
  { caseStudyIcon: "hvacSystemModeling", title: "Space Utilization & Routing Optimization" },
  { caseStudyIcon: "clashDetection", title: "Clash Detection & Coordination" },
  { caseStudyIcon: "constructionDocs", title: "Shop Drawing Preparation" },
];
...
const CHALLENGE_LEFT = [
  ...
  },
  {
    ...
    text: "Coordinating multiple mechanical systems operating within a shared confined zone.",
  },
];
...
const CHALLENGE_RIGHT = [
  {
    ...
    title: "Construction-Ready Model Output",
    text: "Ensuring model readiness for shop drawing extraction.",
  },
  {
...
function ClashFreeBimModelingForMechanicalPlantRomPage() {
  useEffect(() => {
            ...
            <div className="hvac-hero__top">
              <Reveal>
                <h1 className="hvac-hero__title fw-bold text-dark">
                  <span className="acc">Clash-Free BIM Modeling</span> for Plant Room Refurbishment Project, UK
                </h1>
                <p className="hero-sub lead text-secondary">Delivered precise LOD 300 BIM modeling and coordination for complex mechanical plant room systems within a tight two-week timeline.</p>
              </Reveal>
              <Reveal delayClass="d1">
                <div className="hero-img-wrap">
                  <img
                    src={CS_IMG.ductPipe3d}
                    alt="Clash-free BIM modeling for mechanical plant room refurbishment project in the UK"
                  />
            ...
            <Reveal delayClass="d1">
              <div className="ov-body">
                <p className="text-secondary">
                  When a UK-based MEPF team needed precise BIM support for a building refurbishment and new block extension, they partnered with us. The scope covered detailed LOD 300 modeling of mechanical plant room systems. With a two-person team and a two-week timeline, we translated schematic diagrams and plan layouts into a fully coordinated 3D Revit model, ready for clash-free construction execution.
                </p>
              </div>
            </Reveal>
          </div>
          ...
          <div className="wrap">
            ...
            <div className="testi-sec">
              <Reveal delayClass="d1" className="testi-inner">
                <p className="text-secondary">
                  &quot;Working with VBS was a highly professional experience. The team demonstrated strong expertise in translating schematic diagrams into accurate 3D models using Autodesk Revit, ensuring effective coordination and clarity of complex mechanical systems.&quot;
                </p>

                <div className="testi-author testi-author--brand">
                  — Digital Delivery Head, MEP
                </div>
              </Reveal>
            </div>
          </div>
              ...
              <div className="">
                <div className="cta-inner">
                  <h2 id="hvac-cta-heading" className="cta-h text-dark">
                    Ready to turn complex schematics into a clash-free BIM model?
                  </h2>
                  <button
                    type="button"
                  ...
                  >
                    Let Us Handle Your Next Plant Room Project
...
export default ClashFreeBimModelingForMechanicalPlantRomPage;
