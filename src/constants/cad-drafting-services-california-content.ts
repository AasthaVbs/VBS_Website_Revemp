...
export const CAD_CA_CONTACT_ID = "cad-ca-contact";
export const CAD_CA_CONTACT_HASH = `#${CAD_CA_CONTACT_ID}`;

export const cadDraftingServicesCaliforniaPage: LocationServicePageContent = {
  pageClassName:
  ...
  contactId: CAD_CA_CONTACT_ID,
  contactHash: CAD_CA_CONTACT_HASH,
  contactDescription:
    "Tell us about your California CAD drafting scope and timeline — we'll match you with vetted, code-compliant drafters ready to start.",
  hero: {
    tag: "CAD Drafting Services",
    titleLead: "CAD Drafting ",
    titleAccent: "Services in California",
    description:
      "Frustrated with design errors, coordination headaches, or last-minute changes? Our CAD drafting experts help architects and engineers in California get code-compliant, permit-ready drawings.",
    ctaLabel: "Get Your BIM Expert now",
    imageSrc: acsBimNewYorkBanner,
    imageAlt: "California city skyline representing CAD drafting services in California",
    copyMaxWidth: 730,
  ...
  overview: {
    tag: "Overview",
    titleLines: [
      { text: "Helping California Architects and Engineers", accent: false },
      { text: "Get Schematic Design Drafting to Permitting", accent: true },
    ],
    description:
      "At Virtual Building Studio, we know what it's like to juggle tight deadlines, missing documentation, last-minute redline updates, and as-built revisions, all while trying to coordinate multiple teams across a fast-paced California project. Our US-trained CAD drafters create precise CAD drawings that reflect your design intent, reduce errors, and make collaboration and planning far less stressful. With our on-demand CAD drafting services, you can stay fully compliant with California building codes, avoid costly delays, and keep projects moving smoothly, without the expense or stress of hiring a full-time local drafter.",
    ctaLabel: "Get your Free trial now",
    ctaHref: CAD_CA_CONTACT_HASH,
  ...
  whyChooseId: "cad-ca-why-choose",
  whyChooseSection: {
    tag: "Why Choose us",
    titleLine1: "Why AEC Firms in California Choose ",
    titleAccentLead: "",
    titleAccentRest: "Our CAD Drawing Services",
    titleParts: [
      { text: "Why AEC Firms in California Choose ", className: "mep-figma-why-choose__title-dark" },
      {
    ...
    description:
      "Whether it's updating redlines, creating as-built drawings, converting CAD files, or preparing permit-ready plans, we help California AEC firms stay on track, avoid costly mistakes, and keep projects moving without stress.",
  ...
  whyChooseItems: [
    {
      title: "We Know California Codes",
      description:
        "CBC, Title 24 energy standards, and local regulations can be tricky, and we make sure every drawing is compliant so you can avoid costly surprises and delays.",
    ...
    },
    {
      ...
      description:
        "From Los Angeles high-rises to Bay Area hospitals and industrial sites, we have been helping firms solve the real challenges of California projects.",
      icon: benefitIconMuted,
      iconHover: benefitIconColored,
    },
    {
  ...
  industries: {
    ...
    description:
      "From high-rise and healthcare facilities to industrial plants, we help California architectural and engineering firms create accurate, code-compliant, permit-ready CAD drawings that keep every project on time and on budget.",
    titleMaxWidth: 817,
    introMaxWidth: 890,
  },
  engagement: {
