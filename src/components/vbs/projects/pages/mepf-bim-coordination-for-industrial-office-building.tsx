...
const CS_IMG = {
  ...
  ductPipe3d: encodeURI("/image/MEPF-BIM-Coordination-for-Industrial-Office-Building-Florida,-USA.png"),
  inputOutputDiagram: encodeURI("/image/Input-Output-four.svg"),
  ...
  executionStrategy2: encodeURI("/image/Execution Strategy-four.svg"),
};
...
const META_ITEMS = [
  { icon: "building-2", label: "Project Type", value: "Industrial Facility" },
  { icon: "layers", label: "Level of Development", value: "LOD 350" },
  { icon: "users", label: "Manpower Used", value: "4 Resources" },
  { icon: "map-pin", label: "Location", value: "Florida, USA" },
];
...
const SCOPE_ITEMS = [
  { caseStudyIcon: "mechanicalSystemModeling", title: "Plumbing System Modeling" },
  { caseStudyIcon: "hvacSystemModeling", title: "HVAC System Modeling" },
  { caseStudyIcon: "constructionDocs", title: "Fire Protection System Modeling" },
  { caseStudyIcon: "clashDetection", title: "Clash Detection and Resolution" },
  { caseStudyIcon: "coordinationMeetings", title: "Multi-trade MEP Coordination" },
];
...
const IMPACT_ITEMS = [
  ...
  { big: "85", suffix: "%", label: "Project Efficiency" },
...
export function CaseStudyVbsIcon({ variant, className = "" }) {
  const svgProps = {
    width: 28,
    height: 28,
    viewBox: "0 0 26 26",
...
export function ChallengePairedGrid({ leftItems, rightItems }) {
...
function MepfBimCoordinationForIndustrialOfficeBuildingPage() {
  useEffect(() => {
            ...
            <div className="hvac-hero__top">
              <Reveal>
                <h1 className="hvac-hero__title fw-bold text-dark">
                  <span className="acc">MEPF BIM Coordination</span> for Industrial Office Building: Florida, USA
                </h1>
                <p className="hero-sub lead text-secondary">LOD 350 BIM modeling for Plumbing, HVAC, and Fire Protection systems delivered in 7 days for seamless coordination and efficient space use.</p>
              </Reveal>
              <Reveal delayClass="d1">
                <div className="hero-img-wrap">
                  <img
                    src={CS_IMG.ductPipe3d}
                    alt="MEPF BIM coordination — 3D plumbing, HVAC, and fire protection systems for the Florida industrial office project"
                  />
              ...
              <div className="">
                <div className="cta-inner">
                  <h2 id="hvac-cta-heading" className="cta-h text-dark">
                    Got a tight deadline and a complex MEP scope?
                  </h2>
                  <button
                    type="button"
...
export default MepfBimCoordinationForIndustrialOfficeBuildingPage;
