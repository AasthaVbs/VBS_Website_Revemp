...
const SwiperImage1 = "/image/project4-slider1.jpg";
const SwiperImage2 = "/image/project4-slider2.jpg";
const SwiperImage3 = "/image/project4-slider3.jpg";
...
const MepfModelingWithClash = () => {
    const data = [
        { id: 1, text: "LOD 300 MEPF Model" },
            ...
            <section className="home-banner-2 pb-10 pt-4 vbs-project-detail-hero" style={{ backgroundImage: `url(${bannerImage})` }} >
                <Container>
                    <Col lg={9} xs={12} className="text-center mx-auto">
                        ...
                        <h1>MEPF Modeling with Clash Detection & Coordination</h1>
                    </Col>
                </Container>
            </section>
...
export default MepfModelingWithClash;